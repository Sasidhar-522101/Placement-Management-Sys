...
public class AdminController 
{
	...
	@GetMapping("adminhome")
	  public ModelAndView adminhome() {
	    ...
	    mv.addObject("studentcount",adminSerivce.noofstudents());
	    mv.addObject("jobcount",adminSerivce.noofjobs());
	    mv.addObject("hirerate",adminSerivce.hirerate());
	    mv.addObject("ccount",adminSerivce.noofcompanies());
	    return mv;
	  }
    ...
    public String updatestudentstatus(@RequestParam("status") String status, @RequestParam("stid") Long stid)
    {
      adminSerivce.updatestudentstatus(status, stid);
